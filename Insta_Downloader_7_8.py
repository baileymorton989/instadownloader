...
class TkinterSelector:
        ...
        def photo_entry(self):            
            ...
            self.label_profile_type = tk.Label(self.root, text='Enter Profile Type : "Public" or "Private"')
            ...
            self.label_password = tk.Label(self.root, text='Enter Password : If public profile, enter "None"')
            ...
            #get range of time
            return self.username, self.password, self.photo, self.profile_type
...
if __name__ == '__main__':
    ...
    username, password, photo_range, profile_type = selector.photo_entry()
